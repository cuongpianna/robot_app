        ...
        <sticky :z-index="10" class-name="sub-navbar">
          <div class="page-title">
            ...
            <div class="action-container">
              ...
              <span class="btn-add-camera" @click="manageMedia" v-if="formTitle === generateTitleView('editRobot', 'robot')">{{ generateTitleView('manageMedia', 'robot') }}</span>
              ...
              <div class="info-content">
                <div class="form">
                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('robotName', 'veeValidate')">
                        <v-text-field
                    ...
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('code', 'veeValidate')">
                        <v-text-field
                  ...
                  <el-row class="md-10">
                    <el-col :span="24" class="vibotDateWrap" :gutter="40">
                      <thumb-upload
                  ...
                  <el-row class="mb-10">
                    <div class="info-title">{{ generateTitleView('config', 'robot') }}</div>
                  </el-row>

                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('ip', 'veeValidate')">
                        <v-text-field
                          v-model="formCreate.ip"
                          :label="generateTitleView('ip', 'robot')"
                          outlined
                          :height="10"
                          @change="changeIp"
                        />
                    ...
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('port', 'veeValidate')">
                        <v-text-field
                          v-model="formCreate.port"
                          :label="generateTitleView('port', 'robot')"
                          outlined
                          :height="10"
                        />
                        <span class="vee-errors">{{ errors[0] }}</span>
                  ...
                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('ip', 'veeValidate')">
                        <v-text-field
                          v-model="formCreate.privateIP"
                          :label="generateTitleView('privateIp', 'robot')"
                          outlined
                          :height="10"
                        />
                        <span class="vee-errors">{{ errors[0] }}</span>
                    ...
                    <el-col :span="12">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('port', 'veeValidate')">
                        ...
                        <v-text-field
                          v-model="formCreate.privatePort"
                          :label="generateTitleView('privatePort', 'robot')"
                          outlined
                          :height="10"
                        />
                  ...
                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="24">
                      <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('videoCallUrl', 'veeValidate')">
                        <v-text-field
                  ...
                  <el-row class="mb-10">
                    <div class="info-title">{{ generateTitleView('area', 'robot') }}</div>
                  </el-row>
                  ...
                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="24">
                      <div class="title-wrapper">
                        <h3 class="cameraTitle">{{ generateTitleView('cameraList', 'camera') }} ({{ formCreate.cameras.length }})</h3>
                      ...
                      <md-table v-model="formCreate.cameras" md-card>
                        ...
                        <md-table-row slot="md-table-row" slot-scope="{ item }" md-auto-select>
                          ...
                          <md-table-cell :md-label="generateTitleView('cameraIp', 'camera')">{{ item.ip }}</md-table-cell>
    ...
    <v-dialog v-model="showDialog" max-width="550">
      <v-card>
        ...
        <div class="search">
          ...
          <button class="btn-search"><font-awesome-icon icon="search" color="#fff" @click="searchCamera" /></button>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            manageMedia() {
             ...
             // alert('/#/robots/index/'+robotId);
                 window.location.href = '/#/users/robots/media/' + robotId
              // this.hasPermissionAction(this.roleList, Permissions.RobotDelete, 'robotmedia/index/'+robotId, this.generateTitleView('permissionMessage', 'message'))
            },
            editRobot() {
          ...
          changeIp() {
            this.formCreate.videoCallUrl = 'https://' + this.formCreate.ip + '/' + this.formCreate.code
          },
          generate(n) {
            var add = 1
            var max = 12 - add
