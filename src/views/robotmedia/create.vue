                  ...
                  <el-row :gutter="40" class="mb-10">
                    <el-col :span="12">
                      <ValidationProvider
                        v-slot="{ errors }"
                        rules="required"
                        :name="generateTitleView('mediaName', 'veeValidate')"
                      >
                        <v-text-field
...
import * as ACTIONS from '../../store/constants/robotmedia'
import * as ROBOT_ACTIONS from '../../store/constants/robot'
import Vue from 'vue'
import { b64EncodeUnicode, b64DecodeUnicode } from '../../help/utils/stringHelper'
  ...
  computed: {
    ...mapGetters({
     ...
     _backLink() {
        ...
        return '/users/robots/media/' + currentRobotId
    }
  },
  mounted() {
