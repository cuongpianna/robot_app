    ...
    <sticky :z-index="10" class-name="sub-navbar">
      <div class="page-title">
        <div class="title-container">
          <router-link to="/dashboard" title="DashBoard" class="back-link">
        ...
        <div class="action-container">
          <el-button icon="el-icon-plus" type="primary" class="btn-create-hotel"
                     @click="hasPermissionAction(roles, 'Role_Create', 'users/role/create', permissionMessage)">
            {{ generateTitleView('createRole', 'role') }}
          </el-button>
        </div>
      </div>
    </sticky>
    <div class="filter">
      <div class="filter-content">
        ...
        <div class="item-action">
          ...
          <el-button type="primary" plain class="btn-search" @click="getRole">{{
              generateTitleView('search', 'role')
            }}
          </el-button>
        </div>
      </div>
...
<!--                <span>Full Quyền</span>-->
            ...
            <ul v-if="item.moduleFunction.length" class="item-body" :data-module-id="item.id">
              ...
              >
                ...
                <el-checkbox v-model="itemModule.isChecked" class="checkbox-item" :data-module-id="item.id"
                             :data-function-id="itemModule.id" @change="checkFullPermission($event, item.id)"/>
              </li>
            </ul>
          </div>
        </div>
