                ...
                <div class="info-content">
                  <div class="form">
                    <el-row :gutter="40" class="mb-10">
                      <el-col :span="12">
                        <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('username', 'veeValidate')">
                          <v-text-field
                      ...
                      <el-col :span="12">
                        <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('fullName', 'veeValidate')">
                          <v-text-field
                      ...
                      <el-col :span="12">
                        <md-field>
                          ...
                          <md-select id="movie" v-model="formCreate.userType" name="movie">
                            <md-option v-for="(item, index) in userType" :key="index" :value="item.value">{{ item.label }}</md-option>
                          </md-select>
                        </md-field>
                    ...
                    <el-row :gutter="40" class="mb-10">
                      ...
                      <el-col :span="12">
                        <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('phone', 'veeValidate')">
                          <v-text-field
                    ...
                    <el-row :gutter="40" class="mb-10">
                      <el-col :span="12">
                        <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('Fax', 'veeValidate')">
                          <v-text-field
                    ...
                    <el-row :gutter="40" class="mb-10">
                      ...
                      <el-col :span="24">
                        <ValidationProvider v-slot="{ errors }" rules="required" :name="generateTitleView('Address', 'veeValidate')">
                          <v-text-field
...
<style lang="scss" scoped>
  ...
  .app-container /deep/ .v-menu__content{
