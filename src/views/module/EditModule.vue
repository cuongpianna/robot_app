    ...
    <sticky :z-index="10" class-name="sub-navbar">
      <div class="page-title">
        ...
        <div class="action-container">
          ...
          <el-button type="primary" plain class="btn-save" @click="editModule()">{{ generateTitleView('save', 'module') }}</el-button>
        </div>
      </div>
    </sticky>
        ...
        >
          ...
          <el-form-item :label="generateTitleView('functions', 'module')" prop="functions" class="item-role">
            <el-drag-select v-model="functions" style="width:100%;" multiple>
              <el-option v-for="(item, index) in functionList" :key="index + '_' + item.id" :label="item.name" :value="item.id" />
            </el-drag-select>
          </el-form-item>
        </el-form>
      </div>
