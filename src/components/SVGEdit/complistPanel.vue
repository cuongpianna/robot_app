<template>
  <collapse-panel label="Layer" class="fill-parent-h">
    <div v-show="components.length>0" id="complist_panel" :style="listHeight" :class="{isHide:clientVisable}">
      <div class="page-list">
        <div
